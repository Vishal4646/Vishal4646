		...
		<div class="row">
			<div class="col-12 p-0" id="homerow">
				...
				<div class="container-fluid" id="loginForm">
					...
					<h3 class="text-center">Orphanage Registration</h3>
					<form:form action="/orphanageRegistration"
						modelAttribute="orphanage" method="POST">
						<div class="row">
							<div class="col-6">
								<div class="form-group">
									<label for="exampleInputEmail1">Name</label>
									<form:input type="text" path="o_name" class="form-control"
										placeholder="Enter Name" />
								</div>
								<div class="form-group">
									<label for="exampleInputEmail1">Address</label>
									<form:textarea path="o_address" class="form-control"
										placeholder="Enter Full Address" rows="1" />
								</div>
								<div class="form-group">
									<label for="exampleInputEmail1">Email</label>
									<form:input type="email" path="o_email" class="form-control"
							...
							<div class="col-6">
								<div class="form-group">
									...
									<form:input type="text" path="o_desc" class="form-control"
										placeholder="Enter Description" />
								</div>
								<div class="form-group">
									<label for="exampleInputPassword1">Contact Number</label>
									<form:input type="text" path="o_contact" class="form-control"
										placeholder="Enter Whatsapp Number" />
								</div>
								

							</div>
							<button type="submit" class="btn btn-primary btn-block mt-2 pt-2">Register</button>
						</div>
					</form:form>
					<!-- </div> -->
				</div>
