          ...
          <div class="row">
              <div class="col-12 p-0" id="homerow">
                  ...
                  <div class="container-fluid" id="loginForm">
                    ...
                    <h3 class="text-center">Donator Registration</h3>
                       <form:form action="/donatorRegistration" modelAttribute="donator" method="POST"> 
                        <div class="row">
                        <div class="col-6">
                          <div class="form-group">
                            <label for="exampleInputEmail1">Username</label>
                            <form:input path="d_uname" type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter Name" />
                          </div>
                          <div class="form-group">
                          <label for="exampleInputEmail1">Address</label>
                          <form:textarea path="address" rows="5" class="form-control" placeholder="Enter Address" />
                        </div>
                      ...
                      <div class="col-6">
                       <div class="form-group">
                            ...
                            <form:input path="contact" type="text" class="form-control" placeholder="Enter Whatsapp Number" />
                          </div>
                        <div class="form-group">
                          <label for="exampleInputEmail1">Email Id</label>
                          <form:input path="d_email" type="email" class="form-control" placeholder="Enter Email Id" />
                        </div>
                        <div class="form-group">
