		...
		<div class="row">
			<div class="col-12 p-0" id="homerow">
				...
				<div class="container-fluid" id="loginForm">
					...
					<h3 class="text-center">Orphanage</h3>
					<table class="table table-hover table-dark">
						...
						<tbody>
							<c:forEach items="${list }" var="fm">
								<tr>
									<th scope="row">${fm.o_id }</th>
									<td><a href="donationstoOrph?oid=${fm.o_id }">${fm.o_name }</a></td>
									<td>${fm.o_address }</td>
									<td>${fm.o_contact }</td>
									<td>${fm.o_desc }</td>
									<td>${fm.o_email }</td>
									...
									<c:when test="${role == 'Volunteer'}">
										<td><a
										href="https://wa.me/91${fm.o_contact }?text=Thank%20you%20for%20using%20our%20service%2E%20We%20appreciate%20your%20time%2E%2E%2E%20I%27m%20your%20volunteer%2C%20i%27ll%20happy%20to%20serve%20you%20better%2E%2E%2E%20How%20can%20i%20help%20you%3F%3F"
