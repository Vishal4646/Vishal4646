        ...
        <div class="container-fluid">
          <div class="row">
              <div class="col-12 p-0" id="homerow">
                  ...
                  <div class="row">
                    <h3 class="text-center">Donator Login</h3>
                      <form:form action="/donatorLogin" modelAttribute="donator" method="POST"> 
                        <div class="form-group">
                          <label for="exampleInputEmail1">Email address</label>
                          <form:input path="d_email" type="email" style="width:500px" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter email" />
                      
                        </div>
                        <div class="form-group">
                          <label for="exampleInputPassword1">Password</label>
                          <form:input path="d_pass" type="password" style="width:500px" class="form-control" id="exampleInputPassword1" placeholder="Password" />
                        </div>
