		...
		<div class="row">
			<div class="col-12 p-0" id="homerow">
				...
				<div class="container-fluid" id="loginForm">
					...
					<h3 class="text-center">Volunteer Info</h3>
					<table class="table table-hover table-dark">
						...
						<c:forEach items="${list }" var="fm">
							<tr>
								<th scope="row">${fm.v_id }</th>
								<td>${fm.d_uname }</td>
								<td>${fm.contact }</td>
								<td>${fm.d_email }</td>
								<td><a href="https://wa.me/91${fm.contact }?text=Hi" class="btn btn-success"><i class="fa fa-whatsapp"></i> Chat</a></td>
